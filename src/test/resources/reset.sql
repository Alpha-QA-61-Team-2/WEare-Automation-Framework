...
INSERT INTO `personal_profile` (`id`, `birth_year`, `first_name`, `last_name`, `personal_review`, `picture`, `sex`, `location_id`, `member_since`, `picture_privacy`) VALUES
                                                                                                                                                                          ...
                                                                                                                                                                          (41, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-08-19 12:43:13', b'0'),
                                                                                                                                                                          (42, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-08-20 12:43:13', b'0'),
                                                                                                                                                                          (43, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-08-21 12:43:13', b'0');
...
INSERT INTO `users` (`user_id`, `email`, `enabled`, `password`, `username`, `expertise_profile_id`, `personal_profile_id`) VALUES
    (40, 'admin@gmail.com', 1, '$2a$12$R9QFNv.PHNMroI9m8TYZROFtysJG9nJcOShyfKpfGU9fOjuosP0VW', 'admina', 40, 40);

INSERT INTO `users` (`email`, `enabled`, `password`, `username`, `expertise_profile_id`, `personal_profile_id`) VALUES
                                                                                                                    ('martin@gmail.com', 1, '$2a$12$R9QFNv.PHNMroI9m8TYZROFtysJG9nJcOShyfKpfGU9fOjuosP0VW', 'Martin', 40, 41),
                                                                                                                    ('olga@gmail.com', 1, '$2a$12$R9QFNv.PHNMroI9m8TYZROFtysJG9nJcOShyfKpfGU9fOjuosP0VW', 'Olga', 40, 42),
                                                                                                                    ('milko@gmail.com', 1, '$2a$12$R9QFNv.PHNMroI9m8TYZROFtysJG9nJcOShyfKpfGU9fOjuosP0VW', 'Milko', 40, 43);

INSERT INTO `posts_table` (`content`, `date_time`, `is_public`, `picture`, `rank`, `user_id`)
VALUES
    ('Първи пост съдържание', '2024-11-22 10:00:00', b'1', 'https://example.com/picture1.jpg', 4.5, 40);



INSERT INTO `comments_table` (`content`, `date_time`, `post_id`, `user_id`)
VALUES
    ('Това е първият коментар!', '2024-11-22 15:00:00', 64, 40),
    ('Това е вторият коментар, интересен пост!', '2024-11-22 16:00:00', 64, 40);
